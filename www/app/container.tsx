  ...
  return (
    <div className="main-wrapper">
      ...
      <SidebarMenu bg="dark" variant="dark">
        <SidebarMenu.Brand href="https://github.com/ivp-dev/react-bootstrap-sidebar-menu">
        ...
        <SidebarMenu.Toggle>
          <svg aria-hidden="true" viewBox="0 0 16 16" version="1.1" data-view-component="true" height="24" width="24" className="octicon">
        ...
        <SidebarMenu.Collapse getScrollValue={getScrollValue}>
            ...
            <SidebarMenu.Nav>
              ...
              <SidebarMenu.Nav.Item>
                <SidebarMenu.Nav.Link href="https://github.com/ivp-dev/react-bootstrap-sidebar-menu/issues">
                  <SidebarMenu.Nav.Icon><svg className="octicon" viewBox="0 0 16 16" version="1.1" width="16" height="16" aria-hidden="true"><path d="M8 9.5a1.5 1.5 0 100-3 1.5 1.5 0 000 3z"></path><path fill-rule="evenodd" d="M8 0a8 8 0 100 16A8 8 0 008 0zM1.5 8a6.5 6.5 0 1113 0 6.5 6.5 0 01-13 0z"></path></svg></SidebarMenu.Nav.Icon>
              ...
              <SidebarMenu.Nav.Item>
                <SidebarMenu.Nav.Link href="https://github.com/ivp-dev/react-bootstrap-sidebar-menu/actions">
                  <SidebarMenu.Nav.Icon><svg className="octicon" viewBox="0 0 16 16" version="1.1" width="16" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M1.5 8a6.5 6.5 0 1113 0 6.5 6.5 0 01-13 0zM8 0a8 8 0 100 16A8 8 0 008 0zM6.379 5.227A.25.25 0 006 5.442v5.117a.25.25 0 00.379.214l4.264-2.559a.25.25 0 000-.428L6.379 5.227z"></path></svg></SidebarMenu.Nav.Icon>
          ...
          <SidebarMenu.Navbar>
            <SidebarMenu.Navbar.Toggle>
              <svg aria-hidden="true" viewBox="0 0 16 16" version="1.1" height="16" width="16" className="octicon"><path fill-rule="evenodd" d="M11.75 2.5a.75.75 0 100 1.5.75.75 0 000-1.5zm-2.25.75a2.25 2.25 0 113 2.122V6A2.5 2.5 0 0110 8.5H6a1 1 0 00-1 1v1.128a2.251 2.251 0 11-1.5 0V5.372a2.25 2.25 0 111.5 0v1.836A2.492 2.492 0 016 7h4a1 1 0 001-1v-.628A2.25 2.25 0 019.5 3.25zM4.25 12a.75.75 0 100 1.5.75.75 0 000-1.5zM3.5 3.25a.75.75 0 111.5 0 .75.75 0 01-1.5 0z"></path></svg>
              Branches
            </SidebarMenu.Navbar.Toggle>
              ...
              <SidebarMenu.Nav>
                ...
                <SidebarMenu.Nav.Item>
                  <SidebarMenu.Nav.Link href="https://github.com/ivp-dev/react-bootstrap-sidebar-menu/branches/all">
                    <SidebarMenu.Nav.Icon>
                      <svg aria-hidden="true" viewBox="0 0 16 16" version="1.1" data-view-component="true" height="16" width="16" className="octicon">
                        <path xmlns="http://www.w3.org/2000/svg" fill-rule="evenodd" d="M11.75 2.5a.75.75 0 100 1.5.75.75 0 000-1.5zm-2.25.75a2.25 2.25 0 113 2.122V6A2.5 2.5 0 0110 8.5H6a1 1 0 00-1 1v1.128a2.251 2.251 0 11-1.5 0V5.372a2.25 2.25 0 111.5 0v1.836A2.492 2.492 0 016 7h4a1 1 0 001-1v-.628A2.25 2.25 0 019.5 3.25zM4.25 12a.75.75 0 100 1.5.75.75 0 000-1.5zM3.5 3.25a.75.75 0 111.5 0 .75.75 0 01-1.5 0z"/>
                      </svg>
                    </SidebarMenu.Nav.Icon>
