...
type Expand = boolean | 'sm' | 'md' | 'lg' | 'xl';
...
type Bg = typeof Bg[keyof typeof Bg];
...
const App: React.FC<Props> = () => {
  const [bg, setBg] = useState<Bg>(Bg.dark);
  const [expand, setExpand] = useState<Expand>('lg');
  const [collapse, setCollapse] = useState<Expand>('md')

  return (
    <div className={`main-wrapper main-wrapper-responsive-${expand}`}>
      <Navbar className="main-header" bg={bg} variant={bg} expand={collapse}>
      ...
      <SidebarMenu bg={bg} variant={bg} expand={expand} hide={collapse}>
          ...
          <SidebarMenu.Body>
            <SidebarMenu.Nav>
              ...
              <SidebarMenu.Nav.Item>
                <SidebarMenu.Nav.Link href="#issues">
              ...
              <SidebarMenu.Nav.Item>
                <SidebarMenu.Nav.Link href="#pulls">
              ...
              <SidebarMenu.Nav.Item>
                <SidebarMenu.Nav.Link href="#actions">
              ...
              <SidebarMenu.Nav.Item>
                <SidebarMenu.Nav.Link href="#projects">
              ...
              <SidebarMenu.Nav.Item>
                <SidebarMenu.Nav.Link href="#wiki">
              ...
              <SidebarMenu.Nav.Item>
                <SidebarMenu.Nav.Link href="#security">
              ...
              <SidebarMenu.Nav.Item>
                <SidebarMenu.Nav.Link href="#insights">
            ...
            <SidebarMenu.Navbar>
              ...
              <SidebarMenu.Navbar.Collapse>
                <SidebarMenu.Nav>
                  <SidebarMenu.Nav.Item>
                    <SidebarMenu.Nav.Link href="#overview">
                      <SidebarMenu.Nav.Icon>
                  ...
                  <SidebarMenu.Nav.Item>
                    <SidebarMenu.Nav.Link href="#active">
                      <SidebarMenu.Nav.Icon>
                        <svg aria-hidden="true" viewBox="0 0 16 16" version="1.1" data-view-component="true" height="16" width="16" className="octicon">
                  ...
                  <SidebarMenu.Nav.Item>
                    <SidebarMenu.Nav.Link href="#stale">
